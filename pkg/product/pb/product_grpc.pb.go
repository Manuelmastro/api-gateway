...
const (
	...
	ProductService_ViewProducts_FullMethodName  = "/product.ProductService/ViewProducts"
)
...
func (c *productServiceClient) ViewProducts(ctx context.Context, in *ViewProductsRequest, opts ...grpc.CallOption) (*ViewProductsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductService_ViewProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
